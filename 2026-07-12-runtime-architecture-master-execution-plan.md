...
|---|---|---|---|---|
| G0 | in_progress | PR-01 | 待填写 | `services/runtime/evidence/http-contract-baseline.md` |
| G1 | pending | PR-02/PR-03 | 待填写 | 待填写 |
| G2 | pending | PR-04 | 待填写 | 待填写 |
| G3 | pending | PR-05 | 待填写 | 待填写 |
| G4 | pending | PR-06 | 待填写 | 待填写 |
| G5 | pending | PR-07 | 待填写 | 待填写 |
| G6 | pending | PR-08 | 待填写 | 待填写 |
| G7 | pending | PR-09 | 待填写 | 待填写 |
| G8 | pending | PR-10 | 待填写 | 待填写 |
| G9 | pending | PR-11+ | 待填写 | 待填写 |
...
| PR-02 | HTTP contracts/error/system/run split | G1 | PR-01 |
| PR-03 | HTTP profile/project/preview/internal split + gates | G1 | PR-02 |
| PR-04 | Bootstrap/Supervisor | G2 | PR-03 |
| PR-05 | ArtifactManifest + templates | G3 | PR-03 |
| PR-06 | WorkRelease/Packaging/OCI | G4 | PR-05 |
| PR-07 | Operation/desired state/outbox | G5 | PR-04+PR-06 |
| PR-08 | Deployment/Service/NetworkPolicy | G6 | PR-07 |
| PR-09 | Publish/Unpublish/Ingress | G7 | PR-08 |
| PR-10 | Blue/Green/Rollback/GC | G8 | PR-09 |
| PR-11+ | HTTP remaining deep split | G9 | PR-10 或无冲突窗口 |

合并原则：

- 每个 PR 在 main 上 rebase 后执行其完整 gate；
- 不把 PR-07 Publication state 提前合并到未拆分 HTTP 单体；
- PR-04 和 PR-05 可并行开发，但必须分别合并；
- PR-08 不包含 Ingress；
- PR-09 不包含 Update/Rollback；
- PR-10 不引入 StatefulSet/SSR。
...
Start G1
  -> Complete and merge PR-02/PR-03
Start G2 and G3 in parallel
  -> Merge PR-04 and PR-05 independently
Start G4
  -> Merge PR-06
Start G5
  -> Merge PR-07
