...
pub(in crate::http_api) async fn classify_design_profile_edit_conflict(
    store: &RuntimeStore,
    run: &AgentRun,
    user_message: &str,
) -> Result<Option<String>, (StatusCode, Json<ErrorResponse>)> {
...
pub(in crate::http_api) async fn has_design_profile_conflict_state(
    store: &RuntimeStore,
    run_id: &str,
) -> bool {
...
pub(in crate::http_api) fn is_design_profile_override_message(message: &str) -> bool {
