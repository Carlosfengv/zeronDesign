use crate::{
    ...
    model_gateway::{HttpModelGatewayClient, ModelClient},
    ...
    types::{AgentEvent, AgentPhase, AgentRun, AgentRunStatus, ContentSource, ConversationItem},
};
use axum::{
...
pub fn app_state(config: RuntimeConfig) -> AppState {
    AppState {
        model: Arc::new(HttpModelGatewayClient::new(
