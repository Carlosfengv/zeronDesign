  ...
  it("parses runtime SSE events from the shared AgentEvent union", () => {
    const events = [
      ...
      },
      {
        ...
        error: "chunked write failed",
        recoverable: true,
        metadata: { errorKind: "chunk_commit_failed" },
        timestamp: "2026-07-04T00:00:01.600Z",
      },
      {
        type: "tool.recovery_suggested",
        runId: "run-1",
        tool: "fs.write",
        errorKind: "chunk_commit_failed",
        fingerprint: "chunk:fs.write:abc123",
        attempt: 1,
        guidance: "Retry the staged write with smaller chunks.",
        metadata: { retryable: true },
        timestamp: "2026-07-04T00:00:01.700Z",
      },
      {
        type: "chunk.received",
        runId: "run-1",
        ...
        bytes: 1024,
        chars: 900,
        timestamp: "2026-07-04T00:00:01.800Z",
      },
      {
        ...
        chars: 1800,
        sha256: "abc123",
        timestamp: "2026-07-04T00:00:01.900Z",
      },
      {
        ...
        timestamp: "2026-07-04T00:00:01.950Z",
      },
      {
        type: "run.completed",
        runId: "run-1",
